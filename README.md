...
> 本文描述 2026-09-21 的现状。**想知道这个 app 怎么用**，看 [docs/使用手册-2026-09-21.md](docs/使用手册-2026-09-21.md)。`docs/` 里更早的方案、任务书、交接文档是历史材料，与本文冲突时以本文和当前源码为准。
