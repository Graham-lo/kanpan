...
- 机型与系统兼容已做过一轮（2026-09-18，见 `docs/acceptance/兼容-iPhone15+-iPad-iOS18-2026-09-18.md`）：最低系统提到 iOS 18.0，iPad 按「不破」口径把满屏单列页封了 560pt 的内容列，六台机型实测。待办：等另外两个窗口的改动落提交后补跑全量 13 台矩阵。
