...
/* JADX INFO: renamed from: gk.e, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes7.dex */
public final class C7460e extends W {
    public C7460e(C2732n c2732n, String str, sp.aicoin_kline.core.indicator.config.F f10) {
    ...
    public void A(dk.s sVar) {
        ...
        boolean zB2 = x().r()[1].b();
        if (zB) {
            v()[0] = Sf.z.n1(nk.z.e(listF, iP));
        }
        if (zB2) {
            v()[1] = Sf.z.n1(nk.z.e(listF2, iP));
        }
    ...
    @Override // gk.W
    public List E() {
        return Sf.r.q("sellSize", "buySize");
    }
}
