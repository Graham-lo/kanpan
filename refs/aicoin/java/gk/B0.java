...
public final class B0 extends W {
    public B0(C2732n c2732n, String str, sp.aicoin_kline.core.indicator.config.F f10) {
    ...
    public void A(dk.s sVar) {
        ...
        while (i10 < length) {
            ...
            int i13 = i11 + 1;
            if (i12.b()) {
                v()[i11] = Sf.z.n1(ak.c.f28342a.b(listA, listB, AbstractC7609s.f(i12.a(), "PFR") ? "estimatedRate" : "", G()));
            }
            i10++;
            i11 = i13;
        }
    ...
    @Override // gk.W
    public List E() {
        return AbstractC2803q.e("estimatedRate");
    }
