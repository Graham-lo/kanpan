...
@Keep
@Metadata(d1 = {"\u0000.\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0010\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0003\b\u0087\b\u0018\u00002\u00020\u0001:\u0002\u001c\u001dB/\u0012\b\u0010\u0002\u001a\u0004\u0018\u00010\u0003\u0012\b\u0010\u0004\u001a\u0004\u0018\u00010\u0005\u0012\b\u0010\u0006\u001a\u0004\u0018\u00010\u0005\u0012\b\u0010\u0007\u001a\u0004\u0018\u00010\u0003¢\u0006\u0004\b\b\u0010\tJ\u000b\u0010\u0010\u001a\u0004\u0018\u00010\u0003HÆ\u0003J\u000b\u0010\u0011\u001a\u0004\u0018\u00010\u0005HÆ\u0003J\u000b\u0010\u0012\u001a\u0004\u0018\u00010\u0005HÆ\u0003J\u000b\u0010\u0013\u001a\u0004\u0018\u00010\u0003HÆ\u0003J9\u0010\u0014\u001a\u00020\u00002\n\b\u0002\u0010\u0002\u001a\u0004\u0018\u00010\u00032\n\b\u0002\u0010\u0004\u001a\u0004\u0018\u00010\u00052\n\b\u0002\u0010\u0006\u001a\u0004\u0018\u00010\u00052\n\b\u0002\u0010\u0007\u001a\u0004\u0018\u00010\u0003HÆ\u0001J\u0013\u0010\u0015\u001a\u00020\u00162\b\u0010\u0017\u001a\u0004\u0018\u00010\u0001HÖ\u0003J\t\u0010\u0018\u001a\u00020\u0019HÖ\u0001J\t\u0010\u001a\u001a\u00020\u001bHÖ\u0001R\u0013\u0010\u0002\u001a\u0004\u0018\u00010\u0003¢\u0006\b\n\u0000\u001a\u0004\b\n\u0010\u000bR\u0013\u0010\u0004\u001a\u0004\u0018\u00010\u0005¢\u0006\b\n\u0000\u001a\u0004\b\f\u0010\rR\u0013\u0010\u0006\u001a\u0004\u0018\u00010\u0005¢\u0006\b\n\u0000\u001a\u0004\b\u000e\u0010\rR\u0013\u0010\u0007\u001a\u0004\u0018\u00010\u0003¢\u0006\b\n\u0000\u001a\u0004\b\u000f\u0010\u000b¨\u0006\u001e"}, d2 = {"Lsp/aicoin_kline/core/indicator/config/MFIRemote;", "", "input", "Lsp/aicoin_kline/core/indicator/config/MFIRemote$Input;", "output", "Lsp/aicoin_kline/core/indicator/config/MFIRemote$Output;", "app_output", "app_input", "<init>", "(Lsp/aicoin_kline/core/indicator/config/MFIRemote$Input;Lsp/aicoin_kline/core/indicator/config/MFIRemote$Output;Lsp/aicoin_kline/core/indicator/config/MFIRemote$Output;Lsp/aicoin_kline/core/indicator/config/MFIRemote$Input;)V", "getInput", "()Lsp/aicoin_kline/core/indicator/config/MFIRemote$Input;", "getOutput", "()Lsp/aicoin_kline/core/indicator/config/MFIRemote$Output;", "getApp_output", "getApp_input", "component1", "component2", "component3", "component4", "copy", "equals", "", "other", "hashCode", "", "toString", "", "Input", "Output", "lib_release"}, k = 1, mv = {2, 0, 0}, xi = 48)
public final /* data */ class MFIRemote {
    ...
    @Keep
    @Metadata(d1 = {"\u0000 \n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\b\n\u0002\b\u000f\n\u0002\u0010\u000b\n\u0002\b\u0003\n\u0002\u0010\u000e\n\u0000\b\u0087\b\u0018\u00002\u00020\u0001B%\u0012\b\u0010\u0002\u001a\u0004\u0018\u00010\u0003\u0012\b\u0010\u0004\u001a\u0004\u0018\u00010\u0003\u0012\b\u0010\u0005\u001a\u0004\u0018\u00010\u0003¢\u0006\u0004\b\u0006\u0010\u0007J\u0010\u0010\r\u001a\u0004\u0018\u00010\u0003HÆ\u0003¢\u0006\u0002\u0010\tJ\u0010\u0010\u000e\u001a\u0004\u0018\u00010\u0003HÆ\u0003¢\u0006\u0002\u0010\tJ\u0010\u0010\u000f\u001a\u0004\u0018\u00010\u0003HÆ\u0003¢\u0006\u0002\u0010\tJ2\u0010\u0010\u001a\u00020\u00002\n\b\u0002\u0010\u0002\u001a\u0004\u0018\u00010\u00032\n\b\u0002\u0010\u0004\u001a\u0004\u0018\u00010\u00032\n\b\u0002\u0010\u0005\u001a\u0004\u0018\u00010\u0003HÆ\u0001¢\u0006\u0002\u0010\u0011J\u0013\u0010\u0012\u001a\u00020\u00132\b\u0010\u0014\u001a\u0004\u0018\u00010\u0001HÖ\u0003J\t\u0010\u0015\u001a\u00020\u0003HÖ\u0001J\t\u0010\u0016\u001a\u00020\u0017HÖ\u0001R\u0015\u0010\u0002\u001a\u0004\u0018\u00010\u0003¢\u0006\n\n\u0002\u0010\n\u001a\u0004\b\b\u0010\tR\u0015\u0010\u0004\u001a\u0004\u0018\u00010\u0003¢\u0006\n\n\u0002\u0010\n\u001a\u0004\b\u000b\u0010\tR\u0015\u0010\u0005\u001a\u0004\u0018\u00010\u0003¢\u0006\n\n\u0002\u0010\n\u001a\u0004\b\f\u0010\t¨\u0006\u0018"}, d2 = {"Lsp/aicoin_kline/core/indicator/config/MFIRemote$Input;", "", "cc", "", "lowerBand", "upperBand", "<init>", "(Ljava/lang/Integer;Ljava/lang/Integer;Ljava/lang/Integer;)V", "getCc", "()Ljava/lang/Integer;", "Ljava/lang/Integer;", "getLowerBand", "getUpperBand", "component1", "component2", "component3", "copy", "(Ljava/lang/Integer;Ljava/lang/Integer;Ljava/lang/Integer;)Lsp/aicoin_kline/core/indicator/config/MFIRemote$Input;", "equals", "", "other", "hashCode", "toString", "", "lib_release"}, k = 1, mv = {2, 0, 0}, xi = 48)
    ...
    public static final /* data */ class Output {
        ...
        @SerializedName("mfi_disabled")
        private final Boolean mfiDisabled;

        @SerializedName("mfi_lineColor")
        private final String mfiLineColor;

        @SerializedName("mfi_lineWidth")
        private final Integer mfiLineWidth;
        ...
        public Output(String str, Boolean bool, Boolean bool2, String str2, Integer num, Boolean bool3, String str3, Integer num2, Boolean bool4, String str4, Integer num3) {
            ...
            this.mfiDisabled = bool3;
            this.mfiLineColor = str3;
            this.mfiLineWidth = num2;
        ...
        public static /* synthetic */ Output copy$default(Output output, String str, Boolean bool, Boolean bool2, String str2, Integer num, Boolean bool3, String str3, Integer num2, Boolean bool4, String str4, Integer num3, int i10, Object obj) {
            ...
            if ((i10 & 4) != 0) {
                bool2 = output.lowerBandDisabled;
            }
            if ((i10 & 8) != 0) {
                str2 = output.lowerBandLineColor;
            }
            if ((i10 & 16) != 0) {
                num = output.lowerBandLineWidth;
            }
            if ((i10 & 32) != 0) {
                bool3 = output.mfiDisabled;
            }
            if ((i10 & 64) != 0) {
                str3 = output.mfiLineColor;
            }
            if ((i10 & 128) != 0) {
                num2 = output.mfiLineWidth;
            }
            if ((i10 & 256) != 0) {
        ...
        public final Boolean getMfiDisabled() {
            return this.mfiDisabled;
        }

        /* JADX INFO: renamed from: component7, reason: from getter */
        public final String getMfiLineColor() {
            return this.mfiLineColor;
        }

        /* JADX INFO: renamed from: component8, reason: from getter */
        public final Integer getMfiLineWidth() {
            return this.mfiLineWidth;
        }
        ...
        public final Output copy(String bandAreaBackground, Boolean bandAreaDisabled, Boolean lowerBandDisabled, String lowerBandLineColor, Integer lowerBandLineWidth, Boolean mfiDisabled, String mfiLineColor, Integer mfiLineWidth, Boolean upperBandDisabled, String upperBandLineColor, Integer upperBandLineWidth) {
            return new Output(bandAreaBackground, bandAreaDisabled, lowerBandDisabled, lowerBandLineColor, lowerBandLineWidth, mfiDisabled, mfiLineColor, mfiLineWidth, upperBandDisabled, upperBandLineColor, upperBandLineWidth);
        }
        ...
        public int hashCode() {
            ...
            Boolean bool3 = this.mfiDisabled;
            int iHashCode6 = (iHashCode5 + (bool3 == null ? 0 : bool3.hashCode())) * 31;
            String str3 = this.mfiLineColor;
            int iHashCode7 = (iHashCode6 + (str3 == null ? 0 : str3.hashCode())) * 31;
            Integer num2 = this.mfiLineWidth;
        ...
        public String toString() {
            return "Output(bandAreaBackground=" + this.bandAreaBackground + ", bandAreaDisabled=" + this.bandAreaDisabled + ", lowerBandDisabled=" + this.lowerBandDisabled + ", lowerBandLineColor=" + this.lowerBandLineColor + ", lowerBandLineWidth=" + this.lowerBandLineWidth + ", mfiDisabled=" + this.mfiDisabled + ", mfiLineColor=" + this.mfiLineColor + ", mfiLineWidth=" + this.mfiLineWidth + ", upperBandDisabled=" + this.upperBandDisabled + ", upperBandLineColor=" + this.upperBandLineColor + ", upperBandLineWidth=" + this.upperBandLineWidth + ')';
        }
    }

    public MFIRemote(Input input, Output output, Output output2, Input input2) {
        this.input = input;
        this.output = output;
    ...
    public static /* synthetic */ MFIRemote copy$default(MFIRemote mFIRemote, Input input, Output output, Output output2, Input input2, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            input = mFIRemote.input;
        }
        if ((i10 & 2) != 0) {
            output = mFIRemote.output;
        }
        if ((i10 & 4) != 0) {
            output2 = mFIRemote.app_output;
        }
        if ((i10 & 8) != 0) {
            input2 = mFIRemote.app_input;
        }
        return mFIRemote.copy(input, output, output2, input2);
    }
    ...
    public final MFIRemote copy(Input input, Output output, Output app_output, Input app_input) {
        return new MFIRemote(input, output, app_output, app_input);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof MFIRemote)) {
            return false;
        }
        MFIRemote mFIRemote = (MFIRemote) other;
        return AbstractC7609s.f(this.input, mFIRemote.input) && AbstractC7609s.f(this.output, mFIRemote.output) && AbstractC7609s.f(this.app_output, mFIRemote.app_output) && AbstractC7609s.f(this.app_input, mFIRemote.app_input);
    }
    ...
    public String toString() {
        return "MFIRemote(input=" + this.input + ", output=" + this.output + ", app_output=" + this.app_output + ", app_input=" + this.app_input + ')';
    }
}
