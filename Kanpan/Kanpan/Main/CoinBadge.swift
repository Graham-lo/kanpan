...
extension CoinSpec {
  ...
  private static let known: [String: CoinSpec] = [
    ...
    "LINK": CoinSpec(from: "#6AA0FF", to: "#2450D4", mark: stroke([
      "M12 3.2l7.2 4.2v8.9L12 20.5l-7.2-4.2V7.4z"], 2)),
    "ARB": CoinSpec(from: "#5FA8F5", to: "#2B6FD6", mark: stroke([
      "M12 3.2l7.2 4.2v8.9L12 20.5l-7.2-4.2V7.4z"], 2)),
    ...
    "DOT": CoinSpec(from: "#F583B4", to: "#D4136B", mark: fill([
      ...
      "M12 2.8a2 2 0 1 1 0 4 2 2 0 0 1 0-4z", "M12 17.2a2 2 0 1 1 0 4 2 2 0 0 1 0-4z",
      "M4.6 7.1a2 2 0 1 1 0 4 2 2 0 0 1 0-4z", "M19.4 7.1a2 2 0 1 1 0 4 2 2 0 0 1 0-4z",
      "M4.6 13a2 2 0 1 1 0 4 2 2 0 0 1 0-4z", "M19.4 13a2 2 0 1 1 0 4 2 2 0 0 1 0-4z"])),
    "TRX": CoinSpec(from: "#EE6C6C", to: "#C1272D", mark: fill([
      "M3.4 5.2l17.2 3-9.2 11.6-1.4-8.2z", "M3.4 5.2l6.6 6.4-1.4-.2z"])),
    "LTC": CoinSpec(from: "#B9C2CC", to: "#6A7480", mark: .text("Ł")),
    "TON": CoinSpec(from: "#63C4F0", to: "#1E88C9", mark: fill([
      "M4.2 6.4h15.6L12 20.2z"])),
    ...
    "OP": CoinSpec(from: "#F2686E", to: "#CE1F26", mark: stroke([
      "M12 5.6a6.4 6.4 0 1 1 0 12.8 6.4 6.4 0 0 1 0-12.8z"], 2.4)),
    "APT": CoinSpec(from: "#8E95A3", to: "#2C333F", mark: stroke([
      "M12 4.6a7.4 7.4 0 1 1 0 14.8 7.4 7.4 0 0 1 0-14.8z", "M5.4 9.8h13.2"], 1.9)),
