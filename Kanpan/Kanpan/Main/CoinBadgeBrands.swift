...
extension CoinSpec {
  ...
  private static let chips: [String: CoinSpec] = [
    ...
    "SNDK": CoinSpec(from: "#E8C07A", to: "#B08420", mark: fill([
      "M7 4.4h7.2l3.8 3.8v11.4H7zM8.4 6.2v3.6h1.7V6.2zM10.9 6.2v3.6h1.7V6.2z"])),
  ...
  private static let software: [String: CoinSpec] = [
    ...
    "MDB": CoinSpec(from: "#9FD48C", to: "#3E8B2C", mark: fill([
      "M5.6 6.4a6.4 2.4 0 1 1 12.8 0v1.8a6.4 2.4 0 0 1-12.8 0z",
      "M5.6 11.4a6.4 2.4 0 1 1 12.8 0v1.8a6.4 2.4 0 0 1-12.8 0z",
      "M5.6 16.4a6.4 2.4 0 1 1 12.8 0v1.8a6.4 2.4 0 0 1-12.8 0z"])),
    // Datadog：一只探头的狗。
  ...
  private static let consumer: [String: CoinSpec] = [
    ...
    "MRK": CoinSpec(from: "#7FC4B8", to: "#0E7C6E", mark: fill([
      "M9.4 3.6h5.2v2.4h-1v3.6l3.1 6.6a3.2 3.2 0 0 1-2.9 4.6H9.2a3.2 3.2 0 0 1-2.9-4.6L9.4 9.6V6h-1z"])),
    // 莫德纳做 mRNA：一段双螺旋。
  ...
  private static let asia: [String: CoinSpec] = [
    ...
    // 三星电机做被动元件：一颗带端电极的贴片电容。
    "SAMSUNGEM": CoinSpec(from: "#8FB6E8", to: "#2040B0", mark: fill([
      "M3.4 8.2h3.6v7.6H3.4z",
      "M17 8.2h3.6v7.6H17z",
      "M7.6 9.6h8.8v4.8H7.6z"])),
...
extension CoinSpec {
  ...
  private static let chainsB: [String: CoinSpec] = [
    ...
    // Fetch.ai：三个节点连成的网。
    "FET": CoinSpec(from: "#9CC7F5", to: "#2D63C8", mark: .parts([
      Part(d: ["M12 6.6L6.6 16.2", "M12 6.6l5.4 9.6", "M6.6 16.2h10.8"], stroke: 2.2),
      Part(d: [
               "M12 3.6a3 3 0 1 1 0 6 3 3 0 0 1 0-6z",
               "M6.6 13.4a3 3 0 1 1 0 6 3 3 0 0 1 0-6z",
               "M17.4 13.4a3 3 0 1 1 0 6 3 3 0 0 1 0-6z"], stroke: nil)])),
    // STX：Stacks 两横夹两个 V
