...
enum DrawingFieldContract {
  ...
  /// 仓库根：`<root>/Kanpan/AccountCodec/Tests/KanpanAccountCodecTests/<本文件>` 往上退五层。
  ...
  static func generated() throws -> Document {
    ...
    return Document(
      ...
      generatedBy: "Kanpan/AccountCodec/Tests/KanpanAccountCodecTests/DrawingFieldContractTests.swift · DrawingFieldContract",
      howToRegenerate: "这是生成物，不要手改。改 Drawing 的编码或 Kind，然后在仓库根跑 `make sync-contract`。"
        + "两边的测试自动对账：Kanpan/AccountCodec 的 theDrawingContractFileIsWhatDrawingEncodes，"
