...
enum SettingsFieldContract {
  ...
  /// 仓库根。从**这个源文件**往上退五层：
  /// `<root>/Kanpan/KanpanTests/Settings/PrefsFieldPlanTests.swift`。
  ///
  /// 用 `#filePath` 而不是当前工作目录：测试跑在模拟器里的 app 宿主上，CWD 根本不在仓库里
  /// （`make` 从仓库根、手敲 xcodebuild、Xcode 里点又各是一处），拿 CWD 拼路径
